...
public final class CounterOutter {
    ...
    public static final class DecrementAndGetRequest extends com.google.protobuf.GeneratedMessageV3 implements
        ...
        public static final com.google.protobuf.Descriptors.Descriptor getDescriptor() {
            return CounterOutter.internal_static_jraft_DecrementAndGetRequest_descriptor;
        }

        protected FieldAccessorTable internalGetFieldAccessorTable() {
            return CounterOutter.internal_static_jraft_DecrementAndGetRequest_fieldAccessorTable
                    .ensureFieldAccessorsInitialized(DecrementAndGetRequest.class, Builder.class);
        }
        ...
        public boolean equals(final Object obj) {
            ...
            if (!(obj instanceof DecrementAndGetRequest)) {
                return super.equals(obj);
            }
            DecrementAndGetRequest other = (DecrementAndGetRequest) obj;
        ...
        public static DecrementAndGetRequest parseFrom(java.nio.ByteBuffer data)
                throws com.google.protobuf.InvalidProtocolBufferException {
            return PARSER.parseFrom(data);
        }
        ...
        public static DecrementAndGetRequest parseFrom(com.google.protobuf.ByteString data)
                throws com.google.protobuf.InvalidProtocolBufferException {
            return PARSER.parseFrom(data);
        }
        ...
        public static DecrementAndGetRequest parseFrom(byte[] data)
                throws com.google.protobuf.InvalidProtocolBufferException {
            return PARSER.parseFrom(data);
        }
        ...
        public static DecrementAndGetRequest parseFrom(java.io.InputStream input) throws java.io.IOException {
            return com.google.protobuf.GeneratedMessageV3.parseWithIOException(PARSER, input);
        }

        public static DecrementAndGetRequest parseFrom(java.io.InputStream input,
                                                       com.google.protobuf.ExtensionRegistryLite extensionRegistry)
                throws java.io.IOException {
            return com.google.protobuf.GeneratedMessageV3.parseWithIOException(PARSER, input, extensionRegistry);
        }

        public static DecrementAndGetRequest parseDelimitedFrom(java.io.InputStream input) throws java.io.IOException {
            return com.google.protobuf.GeneratedMessageV3.parseDelimitedWithIOException(PARSER, input);
        }

        public static DecrementAndGetRequest parseDelimitedFrom(java.io.InputStream input,
                                                                com.google.protobuf.ExtensionRegistryLite extensionRegistry)
                throws java.io.IOException {
            return com.google.protobuf.GeneratedMessageV3.parseDelimitedWithIOException(PARSER, input,
                    extensionRegistry);
        ...
        public static DecrementAndGetRequest parseFrom(com.google.protobuf.CodedInputStream input)
                throws java.io.IOException {
            return com.google.protobuf.GeneratedMessageV3.parseWithIOException(PARSER, input);
        }
        ...
        public static Builder newBuilder(DecrementAndGetRequest prototype) {
            return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
        }
        ...
        public static final class Builder extends com.google.protobuf.GeneratedMessageV3.Builder<Builder> implements
            ...
            public DecrementAndGetRequest getDefaultInstanceForType() {
                return DecrementAndGetRequest.getDefaultInstance();
            }

            public DecrementAndGetRequest build() {
                DecrementAndGetRequest result = buildPartial();
                if (!result.isInitialized()) {
                    throw newUninitializedMessageException(result);
                }
                return result;
            ...
            public DecrementAndGetRequest buildPartial() {
                DecrementAndGetRequest result = new DecrementAndGetRequest(this);
                int from_bitField0_ = bitField0_;
                int to_bitField0_ = 0;
                if (((from_bitField0_ & 0x00000001) == 0x00000001)) {
                    to_bitField0_ |= 0x00000001;
            ...
            public Builder mergeFrom(com.google.protobuf.Message other) {
                if (other instanceof DecrementAndGetRequest) {
                    return mergeFrom((DecrementAndGetRequest) other);
                } else {
                    super.mergeFrom(other);
                    return this;
                }
            ...
            public Builder mergeFrom(DecrementAndGetRequest other) {
                if (other == DecrementAndGetRequest.getDefaultInstance())
                    return this;
                if (other.hasDelta()) {
                    setDelta(other.getDelta());
                }
            ...
            public Builder mergeFrom(com.google.protobuf.CodedInputStream input,
                                     com.google.protobuf.ExtensionRegistryLite extensionRegistry)
                    throws java.io.IOException {
                DecrementAndGetRequest parsedMessage = null;
                try {
                    parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
                } catch (com.google.protobuf.InvalidProtocolBufferException e) {
                    parsedMessage = (DecrementAndGetRequest) e.getUnfinishedMessage();
                    throw e.unwrapIOException();
                } finally {
                    if (parsedMessage != null) {
                        mergeFrom(parsedMessage);
        ...
        private static final DecrementAndGetRequest DEFAULT_INSTANCE;
        static {
            DEFAULT_INSTANCE = new DecrementAndGetRequest();
        }

        public static DecrementAndGetRequest getDefaultInstance() {
            return DEFAULT_INSTANCE;
        }
    ...
    static {
        ...
        internal_static_jraft_DecrementAndGetRequest_descriptor = getDescriptor().getMessageTypes().get(3);
        internal_static_jraft_DecrementAndGetRequest_fieldAccessorTable = new com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
                internal_static_jraft_DecrementAndGetRequest_descriptor, new String[] { "Delta", });
    }
